...
int main(void)
{
    ...
    // append_value(0, arr_pointer);
    // print_array(arr_pointer);
    // remove_value(0, arr_pointer);
    print_array(arr_pointer);
    add_at_index(256, 10, arr_pointer);
    print_array(arr_pointer);
    // int min = find_minimum(arr_pointer);
    // int max = find_maximum(arr_pointer);
    // printf("Min: %d, Max: %d\n", min, max);
    // size_t first_search = find_value(0, arr_pointer);
    // size_t second_search = find_value(-99, arr_pointer);
    // printf("\nFirst index of 0: %d, Index of -99: %d\n", first_search, second_search);
    //printf("\nFirst value in array: %d\n", arr_pointer->items[0]);
    return 0;
}
...
void fill_array(size_t amount, DynArr *array){
    ...
    for (size_t x = 0; x < amount; ++x){
        ...
        append_value(random_number, array);
    }
}
/*
...
Returns: N/A
 */
void append_value(int value, DynArr *array){
